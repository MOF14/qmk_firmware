...
float output;
static int image_count = 0; //default to first image
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
       KC_TRNS,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                         KC_6,  KC_P7,   KC_P8,   KC_P9,  KC_0,  KC_BSPC,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, XXXXXXX,                       KC_NLCK,  KC_P4,   KC_P5,   KC_P6,  KC_PMNS, KC_PAST,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TRNS,LCTL(KC_Z),LCTL(KC_X),LCTL(KC_C),XXXXXXX,LCTL(KC_V),              KC_P0,  KC_P1,   KC_P2,   KC_P3,  KC_PPLS, KC_PENT,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LGUI, KC_TRNS, KC_TRNS,     MO(_ADJUST), KC_P0, KC_PDOT
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, XXXXXXX,                      KC_MINS,  KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS,  KC_GRV,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_TRNS,LCTL(KC_Z),LCTL(KC_X),LCTL(KC_C),XXXXXXX,LCTL(KC_V),                      KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_TILD,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
        RESET, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TG(_CAD_NUM),       TG(_QWERTY), TG(_CAD_FN), XXXXXXX, XXXXXXX, XXXXXXX, TG(_COLEMAKDH_GAMING),
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
  ...
  [_CAD_FN] = LAYOUT_split_3x6_3( //CAD layout for Fusion360
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      KC_ESC,   KC_ENT,   KC_Q,   KC_W,   KC_E,   KC_R,                           XXXXXXX, KC_P7,   KC_P8,   KC_P9,  KC_0,  KC_BSPC,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LCTL,    KC_F,   KC_A,   KC_S,   KC_D,   KC_L,                         KC_NLCK,  KC_P4,   KC_P5,   KC_P6,  KC_PMNS, KC_PAST,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT,    KC_Z,   KC_Z,   KC_X,   KC_C,   KC_C,                         KC_P0,  KC_P1,   KC_P2,   KC_P3,  KC_PPLS, KC_PENT,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                        KC_N, LCTL_T(KC_ENT), TG(_CAD_NUM),    MO(_ADJUST), KC_P0, KC_PDOT
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      KC_PSLS, KC_PAST, KC_7,     KC_P8,   KC_9,  KC_BSPC,                     KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_PMNS, KC_PPLS, KC_P4,     KC_5,    KC_P6,  KC_DOT,                      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
LT(_ADJUST, KC_NUM), XXXXXXX,  KC_1,    KC_P2,    KC_3,    KC_0,                KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_BSPC, KC_ENT,TG(_CAD_NUM),    MO(_ADJUST),  KC_TRNS,  KC_TRNS
                                      //`--------------------------'  `--------------------------'
  ),
...
//      //paste byte array here
//      static const char PROGMEM behelit_logo[] = {
//         // 'behelit', 128x32px VERTICAL 1-bit per pixel
...
static void devilHouse_logo(void) {
     ...
     static const char PROGMEM devilHouse_logo[] = {
        // 'Devil Housepng', 128x32px VERTICAL 1-bit per pixel black background
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0xe0, 0xe0, 0xf0, 0xf8, 0xd8, 0x9c, 0xfe, 0x47, 0x5e, 
        0xff, 0x5c, 0xe4, 0x7c, 0xfc, 0xf0, 0xcc, 0x7c, 0x04, 0x7c, 0xf4, 0xfc, 0xf8, 0xc0, 0x00, 0x00, 
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
        ...
        , 
...
static void cycle_logo(void) { //iterate through multiple OLED images at the press of a button
    ...
    static const char PROGMEM devilHouse_logo[] = {
        ...
        // 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xfd, 0xc1, 0x0c, 0x00, 0x34, 0x03, 0x82, 0x20, 0xc0, 0x62, 0x04, 
        // 0x84, 0xf0, 0xa0, 0xe6, 0xf4, 0x80, 0xdf, 0x40, 0x53, 0x48, 0x00, 0x00, 0x00, 0x00, 0x18, 0x03, 
        // 0x53, 0x3b, 0x7f, 0x2f, 0x27, 0x7f, 0x7f, 0x7f, 0xff, 0x7f, 0x77, 0xff, 0xf7, 0xf7, 0xff, 0xff, 
        // 0xf7, 0x7f, 0xff, 0xff, 0x7f, 0x7f, 0x7f, 0x7f, 0x7f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
        ...
        // 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
        // 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
        // 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfc, 0xf4, 0xc5, 0x00, 0x84, 0x82, 0x00, 0xa0, 
        // 0x00, 0x25, 0x04, 0x46, 0xc1, 0x80, 0xd5, 0xc3, 0xc0, 0x12, 0x00, 0x00, 0x00, 0x00, 0x40, 0x08, 
        // 0xa0, 0xe0, 0xae, 0xee, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 
        // 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
        // 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
        // 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
        // 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
        // 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
        // 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfc, 0xfa, 0xf2, 0xe6, 
        // 0xe0, 0xc0, 0xa8, 0x00, 0x03, 0xcf, 0x8e, 0xc7, 0x8d, 0x8f, 0x88, 0x82, 0x80, 0x80, 0xd0, 0x80, 
        // 0xe6, 0xff, 0xfe, 0xfe, 0xee, 0xff, 0xff, 0xfd, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
        // 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 
...
//     //     image_count = 0; //reset to first image
//     //     }
// } //don't know why this isn't running multiple times.
...
bool process_record_user(uint16_t keycode, keyrecord_t *record){
    ...
    switch (keycode) {
        ...
        case OLED_BRIGHTER:
            if (record->event.pressed) {
                if (OLED_BRIGHTNESS_VAL <= 204 && OLED_BRIGHTNESS_VAL >= 51) {
